                            ...
                            <div style="border: 1px solid #E5E7EB; border-radius: 8px; margin-bottom: 30px;">
                                ...
                                <div>
                                    ...
                                    <div style="padding: 12px;">
                                        ${n.routes.map(F=>{var s,o,j,T,B,he,le,fe,ne,Z;const{lay_over:W,operating:{carrier_name:K,carrier:f,flight_number:d,carrier_logo:me},aircraft:{name:ee},departure_time:ae,origin_airport:{name:te},origin_terminal:re,arrival_time:se,destination_airport:{name:ue,destination_terminal:ie},flight_time:xe,baggages:u,booking_class:t}=F;return`
                                        <div>
                                            ...
                                            <div style="display: flex; margin-bottom: 16px;">
                                                <img style="border: 1px solid #f0f0f0; width: 2.4rem; height: 2.4rem; border-radius: 50%; margin-right: 12px;"
                                                    ...
                                                    alt="" />
                                                <h6 style="font-weight: 500;">${K} <span
                                                    ...
                                                    <td style="width: 100%;">
                                                        <div>
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-weight: 500; margin-right: 2px;">
                                                                    ${((Z=(ne=u==null?void 0:u.carry_on)==null?void 0:ne.CNN)==null?void 0:Z.title)||"7 kg*"}{" "}
                                                                    for
                                                                    CNN
                                                                </p>
                                                            </div>
